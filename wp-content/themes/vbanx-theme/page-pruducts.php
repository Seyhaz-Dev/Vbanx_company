  ...
  <div class="t24-hero__inner">
    ...
    <div class="t24-hero__panel">
      ...
      <h1 class="t24-hero__title">
        <span class="t24-hero__title-accent">T24</span>
        <span class="t24-hero__title-main">Completed<br>Solutions</span>
      </h1>

      <p class="t24-hero__desc">
            Empowering Cambodian financial institutions with secure, 
    scalable core banking software — built for CIFRS compliance and digital-
    first growth.
      </p>
...
<style>
  ...
  .t24-hero__inner {
    ...
    background-image: url('http://localhost/wordpress/wp-content/uploads/2026/07/Frame-bg.png');
  }
